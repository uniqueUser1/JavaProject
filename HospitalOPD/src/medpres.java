...
import javax.swing.JTextField;
 ...
 public class medpres implements MouseListener //implements Runnable
{
	JFrame loginframe;
	...
	void medpresFrame()
	{
		...
		backpiclab=new JLabel(new ImageIcon(ImageIO.read(getClass().getResourceAsStream("/111.jpg"))));}
		catch (Exception e) {
	...
	public void mouseClicked(MouseEvent me)
	{
		if(me.getSource()==savelab)
		{
			...
			try
			{
				...
				PreparedStatement pstmt=con.prepareStatement("insert into medprestab values(?,?,?,?,?)");
				pstmt.setInt(1,id);
